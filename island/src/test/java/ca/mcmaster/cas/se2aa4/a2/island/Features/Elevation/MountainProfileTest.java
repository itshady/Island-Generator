...
class MountainProfileTest {
    ...
    @Test
    public void CenterHighAltitudeTest() {
        // setup has 10x10 grid and centroid of our tile is (5,5) aka dead middle
        ElevationProfile elevation = new MountainProfile();
