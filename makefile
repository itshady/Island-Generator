...
island:
	cd island && java -jar island.jar -i ../generator/sample.mesh -o lagoon.mesh -shape ciRcLe -altitude cRaTeR -aquifer 2 -lake 5 -river 4 -soil DrY -biomes AmErIcA -visual BiOMe
