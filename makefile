...
island:
	cd island && java -jar island.jar -i ../generator/sample.mesh -o lagoon.mesh -shape threecircle -altitude prairie -aquifer 0 -lake 5 -river 10 -soil wet -biomes asia -seed 625519603
