...
island:
	cd island && java -jar island.jar -i ../generator/sample.mesh -o lagoon.mesh -shape ciRcLe -cities 40 -network nonstarhehe2 -altitude mountain -aquifer 2 -lake 7 -river 5 -soil DrY -biomes AmErIcA
