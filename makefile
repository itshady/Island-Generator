...
island:
	cd island && java -jar island.jar -i ../generator/sample.mesh -o lagoon.mesh -shape square -altitude mountain -aquifer 2 -lake 5 -river 4 -soil dry -biomes america -visual moisture -seed 2087500378
